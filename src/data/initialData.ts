...
export const initialPatients: Patient[] = [
  ...
  },
  {
    ...
    cpf: "614.789.201-33",
    firstSessionDate: getTodayString(-12),
    lastSessionDate: getTodayString(0),
    totalSessions: 3,
    totalFaltas: 0,
    category: "massoterapia",
    ...
    statusTag: "Recuperação Muscular",
    notes: "Atleta amador. Sessões de liberação miofascial e ventosaterapia pós-treinos intensos.",
