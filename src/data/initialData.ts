...
export const initialPatients: Patient[] = [
  {
    ...
    rg: "58.492.103-X",
    profession: "Advogada",
    emergencyContact: "Marcelo Santos (Esposo)",
    emergencyPhone: "(11) 99122-3344",
    ...
    category: "pilates",
    colorTag: "purple",
    tags: ["Pilates Studio", "Postura", "Core", "Mensalista"],
    statusTag: "Assíduo 100%",
    isLocked: false,
    notes: "Frequenta Pilates 2x por semana. Apresenta excelente evolução na estabilização de core e diminuição da dor cervical.",
  ...
  },
  {
    ...
    emergencyContact: "Camila Oliveira (Irmã)",
    emergencyPhone: "(11) 98777-6655",
    address: "Av. Brigadeiro Eduardo Gomes, 1120",
    city: "Altamira - PA",
    ...
    colorTag: "orange",
    tags: ["Pós-Operatório", "Joelho", "Reabilitação", "Atleta Amador"],
    statusTag: "Em Reabilitação",
    isLocked: false,
    notes: "Pós-operatório de joelho direito (meniscectomia). Amplitude de movimento recuperada em 85%.",
  ...
  },
  {
    ...
    emergencyContact: "Roberto Souza (Pai)",
    emergencyPhone: "(11) 98844-1122",
    address: "Travessa 1º de Janeiro, 320",
    city: "Altamira - PA",
    ...
    category: "fisioterapia",
    colorTag: "emerald",
    tags: ["RPG Postural", "Coluna", "Cervicalgia", "Fisioterapia"],
    statusTag: "Tratamento Contínuo",
    isLocked: false,
    notes: "RPG semanal. Alívio significativo das cervicalgias crônicas de postura de escritório.",
  ...
  },
  {
    ...
    rg: "55.819.340-9",
    profession: "Bancária",
    emergencyContact: "Lucas Mendes (Esposo)",
    emergencyPhone: "(11) 99222-1100",
    address: "Rua Otacílio Lino, 890",
    city: "Altamira - PA",
    ...
    category: "pelvica",
    colorTag: "rose",
    tags: ["Fisioterapia Pélvica", "Obstétrica", "Gestante 2º Tri", "Preparo para o Parto"],
    statusTag: "Gestante Ativa",
    isLocked: false,
    notes: "Pilates e Fisioterapia Pélvica para gestante (24 semanas). Foco em assoalho pélvico e mobilidade de quadril.",
    createdAt: getTodayString(-10)
  },
  {
    id: "pat-5",
    name: "Dra. Beatriz Guimarães",
    phone: "(93) 99188-4422",
    email: "beatriz.guimaraes@email.com",
    cpf: "512.981.304-66",
    birthDate: "1985-02-18",
    rg: "39.102.774-3",
    profession: "Médica Pediatra",
    emergencyContact: "Eduardo Guimarães",
    emergencyPhone: "(93) 99144-8899",
    address: "Av. Dair José Porfírio, 1500",
    city: "Altamira - PA",
    firstSessionDate: getTodayString(-45),
    lastSessionDate: getTodayString(0),
    totalSessions: 10,
    totalFaltas: 0,
    category: "fidelidade",
    colorTag: "amber",
    tags: ["Clube Fidelidade R$99", "VIP", "Massoterapia", "Família Ativa"],
    statusTag: "Membro VIP Fidelidade",
    isLocked: false,
    notes: "Assinante ativa do Clube de Vantagens Fisiolys com saldo acumulado. Usa massoterapia e pilates.",
    createdAt: getTodayString(-45)
  },
  {
    id: "pat-6",
    name: "Enzo Gabriel Vasconcelos (Resp: Fernanda)",
    phone: "(93) 99199-4411",
    email: "fernanda.v@email.com",
    cpf: "820.319.450-88",
    birthDate: "2022-03-10",
    guardianName: "Fernanda Vasconcelos (Mãe)",
    emergencyContact: "Fernanda Vasconcelos",
    emergencyPhone: "(93) 99199-4411",
    address: "Rua Magalhães Barata, 610",
    city: "Altamira - PA",
    firstSessionDate: getTodayString(-20),
    lastSessionDate: getTodayString(-2),
    totalSessions: 6,
    totalFaltas: 0,
    category: "aba",
    colorTag: "blue",
    tags: ["Método ABA", "Pediatria", "Integração Sensorial", "Psicomotricidade"],
    statusTag: "Acompanhamento Infantil",
    isLocked: false,
    notes: "Paciente com 4 anos. Estimulação psicomotora, alinhamento postural e integração sensorial em solo lúdico.",
  ...
  },
  {
    ...
    emergencyContact: "Juliana Mendonça",
    emergencyPhone: "(93) 99155-2233",
    address: "Av. João Pessoa, 420",
    city: "Altamira - PA",
    firstSessionDate: getTodayString(-40),
    lastSessionDate: getTodayString(-15),
    totalSessions: 6,
    totalFaltas: 0,
    category: "massoterapia",
    colorTag: "sky",
    tags: ["Massoterapia", "Liberação Miofascial", "Ventosaterapia", "Crossfit"],
    statusTag: "Sessões Trancadas 🔒",
    isLocked: true,
    lockStartDate: getTodayString(-10),
    lockEndDate: getTodayString(20),
    lockReason: "Viagem a Trabalho / Congresso",
    lockNotes: "Sessões pausadas durante viagem ao exterior. Retorno agendado para o final do mês.",
    lockedAt: new Date(Date.now() - 10 * 86400000).toISOString(),
    lockedBy: "Dra. Elays Marinho",
    notes: "Sessões trancadas temporariamente por motivo de viagem a trabalho. Retomará o plano no retorno.",
